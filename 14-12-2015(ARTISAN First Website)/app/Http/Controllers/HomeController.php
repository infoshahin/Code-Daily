...
class HomeController extends Controller
{
    ...
    public function ProductDetails($id)
    {
        ...
        return view('pages.frontend.product-view')->with('product',$product)->with('category',$category)->with('images',$images)->with('related_products',$related_products)->with('related_product_image',$related_product_image);
    }
