                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($products as $product)
                      ...
                      <!-- <td><input type="checkbox" name="ids_to_delete[]" value="{{$product->id}}" /></td> -->
                        ...
                        <td>
                          <div class="col-sm-6">  {!! Form::open(['route' => ['productpicture.edit', $product->id], 'method' => 'GET']) !!}  {!! Form::submit('Edit', ['class' => 'btn btn-block btn-warning btn-sm']) !!} {!! Form::close() !!}</div>
                          <div class="col-sm-6"> {!! Form::open(['route' => ['productpicture.destroy', $product->id], 'method' => 'delete']) !!}  {!! Form::submit('Delete', ['class' => 'btn btn-block btn-danger  <div class="col-sm-6"> btn-sm']) !!} {!! Form::close() !!}</div>
                       </td>
                      </tr>
                      @endcan
                      @endforeach
