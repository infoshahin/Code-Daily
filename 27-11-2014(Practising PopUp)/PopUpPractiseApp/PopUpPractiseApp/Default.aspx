...
<script language="javascript" type="text/javascript">
    function ShowDetailsModal(ExpanseID) {
        ...
        frame.src = "DetailsExpanse.aspx?UIMODE=DETAILS&EID=" + ExpanseID;
        $find('DetailModalPopup').show();
    }
                ...
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkDetails" runat="server" CausesValidation="false" CommandName="" Text="Details"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
