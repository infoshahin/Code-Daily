<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditExpanse.aspx.cs" Inherits="PopUpPractiseApp.EditExpanse" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function getbacktostepone() {
            window.location = "DetailsExpanse.aspx";
        }
        function onSuccess() {
        ...
        function okay() {
            ...
            if (UIMODE == "VIEW")
                window.parent.document.getElementById('ButtonDetailsDone').click();
            else {
        ...
        function cancel() {
            var UIMODE = $get('hdnWindowUIMODE').value;
            if (UIMODE == "VIEW")
                window.parent.document.getElementById('ButtonDetailsCancel').click();
            else
