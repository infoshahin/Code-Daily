<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="PopUpPractiseApp._Default" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ShowDetailsModal(ExpanseID) {
        var frame = $get('IframeDetails');
        frame.src = "EditExpanse.aspx?UIMODE=VIEW&EID=" + ExpanseID;
        $find('DetailsModalPopup').show();
    }

    function DetailsCancelScript() {
        var frame = $get('IframeDetails');
        frame.src = "DemoLoading.aspx";
    }

    function DetailsOkayScript() {
        RefreshDataGrid();
    }
                ...
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                            <asp:LinkButton ID="lnkDetails" runat="server" CausesValidation="false" CommandName=""
                    ...
                    <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="PopUpPractiseApp.ExpanseClassesDataContext"
...
<div id="DivEditWindow" style="display: none;" class="popupConfirmation">
    <iframe id="IframeEdit" frameborder="0" height="203" scrolling="no">
                    ...
                    <%--this is the html code for details window--%>
        <asp:Button ID="ButtonDetails" runat="server" Text="Details Expanse" style="display:none" />
<cc1:ModalPopupExtender ID="ModalPopupExtender3" BackgroundCssClass="ModalPopupBG"
    runat="server" CancelControlID="ButtonDetailsCancel" OkControlID="ButtonDetailsDone" 
    TargetControlID="ButtonDetails" PopupControlID="DivEditWindow" 
    OnCancelScript="DetailsCancelScript();" OnOkScript="DetailsOkayScript();"
    BehaviorID="DetailsModalPopup">
</cc1:ModalPopupExtender>
<div class="popup_Buttons" style="display: none">
    <input id="ButtonDetailsDone" value="Done" type="button" />
    <input id="ButtonDetailsCancel" value="Cancel" type="button" />
</div>
<div id="DivEditWindow" style="display: none;" class="popupConfirmation">
    <iframe id="IframeDetails" frameborder="0" height="203" scrolling="no">
    </iframe>
</div>
    </form>
</body>
