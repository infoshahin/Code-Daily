...
<div class="slideshow">
    <div id="slideshow1">
        <ul class="allinone_bannerRotator_list">
            @foreach($slider_images as $values)
            <li data-text-id="">{!! HTML::image('uploads/'.$values->image, 'a picture') !!}</li>
            @endforeach
...
<!--            <li data-text-id="#content_ss_4">{!! HTML::image('assets/images/slideshow1.jpg', 'a picture') !!}</li>-->
        </ul>
    </div>
</div>
<!-- /.slideshow -->
        ...
        <div class="box-product">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="product-item">
                    <div class="product-thumb">
                        <div class="main-img">
                            <a href="{{ url('/product/'.$values->product_title) }}">
