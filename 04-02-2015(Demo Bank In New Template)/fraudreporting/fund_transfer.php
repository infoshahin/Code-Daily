...
<div id="header">
    <div class="shell">
        ...
        <div id="navigation">
            <ul>
                <li><a href="http://localhost:8080/fraudreporting/profile.php"><span>Account Details</span></a></li>
                <li><a href="http://localhost:8080/fraudreporting/fund_transfer.php" class="active"><span>Fund Transfer</span></a></li>
            </ul>
        </div>
        <!-- End Main Nav -->
    </div>
