...
<div id="header">
    <div class="shell">
        <!-- Logo + Top Nav -->
        <div id="top">
            <h1><a href="http://localhost:8080/fraudreporting/profile.php">User Panel</a></h1>
        ...
        <div id="navigation">
            <ul>
                <li><a href="http://localhost:8080/fraudreporting/profile.php" class="active"><span>Account Details</span></a></li>
                <li><a href="http://localhost:8080/fraudreporting/fund_transfer.php"><span>Fund Transfer</span></a></li>
            </ul>
        </div>
        <!-- End Main Nav -->
    </div>
