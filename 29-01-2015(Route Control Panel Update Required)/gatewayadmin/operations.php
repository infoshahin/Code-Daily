    ...
    <div id="page">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <div id="gp_portion" align="center">
                ...
                <input name="search_stakeholder" type="submit" id="search_stakeholder" value="Search">
...
<table align="center">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                if(isset($_POST["search_stakeholder"]))
                {
                    ...
                    echo'<tr><td>';
                    echo'<select name="stakeholder_list">';
                    ...
                    echo '</select>';
                    echo'</td></tr>';
                    echo'<tr><td><input name="show_details" type="submit" id="search_details" value="Show Details"></td></tr>';
                }
                ?>
<!--            <input name="id" type="hidden" value="--><?php //echo $id; ?><!--">-->
        </form>
