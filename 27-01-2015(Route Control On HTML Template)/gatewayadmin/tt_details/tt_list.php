...
<div id="wrapper">
    ...
    <div id="page">
        ...
        <form action="http://localhost:8080/gatewayadmin/tt_details/tt_details.php" method="POST">
            <div id="tt_details_portion">
                <h2>Teletalk Stakeholders</h2>
                <br>
                Stakeholders
                <?php
                if(isset($_POST["search_tt"]))
                {
                    $masking = mysql_real_escape_string($_POST["search_tt_masking"]);
