...
<div id="wrapper">
    ...
    <div id="page">
        ...
        {
            $request_from = $_POST["bl_list"];
            $query_for_bl = "SELECT * FROM tbl_routing_table WHERE REQUEST_FROM = '$request_from' && IN_TELCO = 'BANGLALINK';";
            $result = mysql_query($query_for_bl);
        ...
        <div id="details">
            <table border="1" align = "center">
                ...
                <tr>
                    ...
                    <td><?php echo "<td><a href='bl_edit.php?id=".$row["ID"]."'>Edit</a></td>";?></td>
                </tr>
            </table>
        </div>
