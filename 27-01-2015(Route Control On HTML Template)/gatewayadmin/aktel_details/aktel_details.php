...
<div id="wrapper">
    ...
    <div id="page">
        ...
        {
            $request_from = $_POST["aktel_list"];
            $query_for_aktel = "SELECT * FROM tbl_routing_table WHERE REQUEST_FROM = '$request_from' && IN_TELCO = 'AKTEL';";
            $result = mysql_query($query_for_aktel);
        ...
        <div id="details">
            <table border="1" align = "center">
                ...
                <tr>
                    ...
                    <td><?php echo "<td><a href='http://localhost:8080/gatewayadmin/aktel_details/aktel_edit.php?id=".$row["ID"]."'>Edit</a></td>";?></td>
                </tr>
