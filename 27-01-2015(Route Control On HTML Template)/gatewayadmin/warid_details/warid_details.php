...
<div id="wrapper">
    ...
    <div id="page">
        ...
        if(isset($_POST["show_details"]))
        {
            ...
            $query_for_warid = "SELECT * FROM tbl_routing_table WHERE REQUEST_FROM = '$request_from' && IN_TELCO = 'WARID';";
            $result = mysql_query($query_for_warid);
        ...
        <div id="details">
            <table border="1" align = "center">
                ...
                <tr>
                    ...
                    <td><?php echo "<a href='http://localhost:8080/gatewayadmin/warid_details/warid_edit.php?id=".$row["ID"]."'>Edit</a>";?></td>
                </tr>
            </table>
        </div>
