...
<div id="wrapper">
    ...
    <div id="page">
        ...
        {
            $request_from = $_POST["citycell_list"];
            $query_for_citycell = "SELECT * FROM tbl_routing_table WHERE REQUEST_FROM = '$request_from' && IN_TELCO = 'CITYCELL';";
            $result = mysql_query($query_for_citycell);
        ...
        <div id="details">
            <table border="1" align = "center">
                ...
                <tr>
                    ...
                    <td><?php echo "<td><a href='http://localhost:8080/gatewayadmin/citycell_details/citycell_edit.php?id=".$row["ID"]."'>Edit</a></td>";?></td>
                </tr>
            </table>
        </div>
