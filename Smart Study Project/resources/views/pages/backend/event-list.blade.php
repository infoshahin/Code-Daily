...
<div class="dev-page-content">
    ...
    <div class="container">
        ...
        <div class="page-title">
            <a href="{{URL::to('event/create')}}"><button class="btn btn-primary btn-clean">Add New</button></a>
        </div>
        <!-- ./page title -->
                ...
                <table class="table table-bordered table-striped table-sortable">
                    ...
                    <tr>
                        <td>
                            ...
                            {
                                ?>
                                {!! HTML::image('event_uploads/'.$value->file, 'a picture', array('width' => '100px','height' => '50px')) !!}
                            <?php
                            }
                            ?>
                            <!--                            {!! HTML::image('notice_uploads/'.$value->file, 'a picture', array('width' => '100px','height' => '50px')) !!}-->
                        </td>
                        <td>{{$value->event_name_en}}</td>
                        <td>{{$value->event_name_en}}</td>
                        <td>{{$value->event_from}}</td>
                        <td>{{$value->event_to}}</td>
                        <td>
                            ...
                            <a href="{{ url('/event/'.$value->id.'/edit') }}" class="btn btn-warning pull-left">Edit</a>
                            <span class="pull-left">&nbsp;</span>
                            {!! Form::open(['url'=>'/event/'.$value->id, 'class'=>'pull-left']) !!}
