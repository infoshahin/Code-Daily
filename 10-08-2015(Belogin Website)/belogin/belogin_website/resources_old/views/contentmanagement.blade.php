...
@section('title', 'Service : Enterprise Content Management')
...
<!--                        <small>Belogin Technologies Ltd.</small>-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <img src="../images/service/content.png" border="5" style="width:120px;height:130px; /*border:2px solid black;*/"><br>
                    <!-- Advanced Tables -->
...
<!--                        </div>-->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <p>
                                    Enterprise Content Management solutions provide the benefits of eliminating hard paper from the office by transforming them to soft documents through the use of proper and secured software. Our designed software must suit your business and appreciate high level of document recording.
                                </p>
                            </div>
