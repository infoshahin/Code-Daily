...
@section('title', 'Service : Web Application Development ')
...
<!--                        <small>Belogin Technologies Ltd.</small>-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <img src="../images/service/webapps.png" border="5" style="width:120px;height:130px; /*border:2px solid black;*/"><br>
                    <!-- Advanced Tables -->
...
<!--                        </div>-->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <p>
                                    Web application is the smart application to take off your organization to the ultimate level. We utilize outstanding resources and rapid application development frameworks to create web based application which is aligned to your true business objectives. You will find the benefits by web applications.
                                </p>
                            </div>
