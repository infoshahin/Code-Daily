...
@section('title', 'Service : SMS Marketing ')
...
<!--                        <small>Belogin Technologies Ltd.</small>-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <img src="../images/service/sms.png" border="5" style="width:120px;height:130px; /*border:2px solid black;*/"><br>
                    <!-- Advanced Tables -->
...
<!--                        </div>-->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <p>
                                    Though every client is different but has the potentials to buy your products. Just remind them frequently about your products through SMS. Branded SMS entitled with your company name may create some faith among the customers towards your products and services. Non-branded SMS will also help you to find the mass prospective customers at a convenient SMS price.
                                </p>
                            </div>
