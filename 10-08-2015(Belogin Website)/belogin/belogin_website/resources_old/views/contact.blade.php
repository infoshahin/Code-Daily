        ...
        <div class="container" >
            ...
            <div class="" id="sidebar">
                ...
                <ul class="nav navbar-nav menu pull-right">
                    ...
                    <li class="active"><a href="http://localhost/belogin/public/contact">CONTACT</a></li>
                </ul>
            </div><!--end sidebar-->
        </div><!--end container-->
    </nav><!--end nav-->
...
<section id="map">
    <div id="container-fluid" style="background-color: #22313F">
        ...
        <div class="row">
            <div id="googleMap" class="show-map col-xs-12" style="width:100%;;"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d913.0588476425089!2d90.41515811043092!3d23.738983959216146!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b86081d2c8ef%3A0x35d17854bd7d0dc8!2sEastern+Plus+Shopping+Mall!5e0!3m2!1sen!2sbd!4v1433317678956" width="100%" height="400" frameborder="0" style="border:0"></iframe></div>
        </div>
    </div>
</section>
<footer id="footer">
...
<!--            </div>-->
            <div class="col-sm-4 contact">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" rows="1" placeholder="Enter Your Message"></textarea>
                    </div>
