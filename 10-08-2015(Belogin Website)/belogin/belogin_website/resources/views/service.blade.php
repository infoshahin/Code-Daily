...
<!--                        <a id="view-service" href="http://localhost/belogin/public/service/softwaredevelopment"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/softwaredevelopment')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="#"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/websitedevelopment')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="http://google.com"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/digitalmarketing')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="#"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/webapp')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
                <br>
                <br>
...
<!--                            <a id="view-service" href="#over-service"><i class="fa fa-search"></i></a>-->
                            <a href="{{URL::to('/erp')}}"><i class="fa fa-link"></i></a>
                        </div>
                </div>
...
<!--                        <a id="view-service" href="#over-service"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/mobileapp')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="#over-service"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/smsmarketing')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="#over-service"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/cloudcomputing')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="#over-service"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/ecommerce')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="#over-service"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/notificamos')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="#over-service"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/contentmanagement')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="#over-service"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/hospitalmanagement')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="#over-service"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/elearning')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
...
<!--                        <a id="view-service" href="#over-service"><i class="fa fa-search"></i></a>-->
                        <a href="{{URL::to('/schoolmanagement')}}"><i class="fa fa-link"></i></a>
                    </div>
                </div>
            </div>
