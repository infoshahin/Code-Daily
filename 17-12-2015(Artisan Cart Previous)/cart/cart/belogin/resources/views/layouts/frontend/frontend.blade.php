...
<header>
    <div class="container">
        <div class="hidden-xs">
            <a class="logo" href="index.html" style="margin-top:-20px;">
        ...
        <div class="header-social">
            <ul class="list-social">
                <li><a href="https://www.facebook.com/Artisan-1375262956106642/?fref=ts" target="_blank" class="facebook"><i class="fa fa-facebook"></i></a></li>
        ...
        <nav class="main-nav">
            <div class="minimal-menu" style="padding: 30px">
                <ul class="menu">
                    ...
                    <li>
                        <a href="{{url('/categories/MAN')}}">MAN</a>
                    </li>
                    <li>
                        <a href="{{url('/categories/WOMAN')}}">WOMAN</a>
                    </li>
                    <li>
                        <a href="{{url('/categories/KIDS')}}">KIDS</a>
                    </li>
                    <li>
                        <a href="{{url('/categories/EXCLUSIVE')}}">EXCLUSIVE</a>
                    </li>
